...
void CServerDisplayer::SetWindowName() //OK
{
	...
	wsprintf(buff,"[%s] MURUBY JoinServer (QueueSize : %d) (AccountCount : %d/%d)",JOINSERVER_VERSION,gSocketManager.GetQueueSize(),gAccountManager.GetAccountCount(),gJoinServerMaxAccount[gProtect.m_AuthInfo.PackageType][gProtect.m_AuthInfo.PlanType]);
	*/
